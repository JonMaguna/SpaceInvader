...
public class BlueTiroEstrategia implements TiroEstrategia {
	...
	public BalaNodo tiroEgin(EspaziontziNodo nodo,int id) {
		...
		case 2:
			...
			return BalaFactory.getnBalaFactory().sortuBala(nodo1.getX(), nodo1.getY() - 4, id, BalaMota.BALA_AZKARRA);
		case 3:
			if(nodo1.getBala3() >= 20) {return null;}
			nodo1.setBala3(nodo1.getBala3() + 1);
			return BalaFactory.getnBalaFactory().sortuBala(nodo1.getX(), nodo1.getY() - 4, id, BalaMota.BALA_HANDIA);
		default:
			return null;
		}
	}
